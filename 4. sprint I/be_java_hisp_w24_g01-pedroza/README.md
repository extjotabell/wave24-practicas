...
La seccion individual tambien tienen su coleccion Postman dentro del mismo directorio:resources/postman_collection/INDIVIDUAL.postman_collection.json y la descripcion del requerimienro **Bonus** esta en :resources/Bonus/Bonus.pdf.
...
| US0011      | Obtener la cantidad de productos en promoción de un determinado vendedor| Individual       	|
| US0012     | BONUS : Consultar los post por categoría y un  límite de precio del producto en oferta | Individual       	|
