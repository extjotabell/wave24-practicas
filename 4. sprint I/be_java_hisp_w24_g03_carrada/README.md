...
|:---------------|:------------|:----------------------------------------------------------------|
| `user_id`      | `int`       | **Required**. id of user                                        |
| `date`         | `LocalDate` | **Required**. date of post (dd-MM-yyyy)                         |
| `product_id`   | `int`       | **Required**. id of product                                     |
| `product_name` | `String`    | **Required**. name of product                                   |
| `type`         | `String`    | **Required**. type of product                                   |
| `brand`        | `String`    | **Required**. brand of product                                  |
...
| `category`     | `int`       | **Required**. category of product. ex 100: Sillas, 58: Teclados |
| `price`        | `double`    | **Required**. price of product                                  |
| `has_promo`    | `boolean`   | **Required**. post with promotion or not                        |
| `discount`     | `double`    | **Required**. discount amount                                   |

###  Individual Development (Bonus)

#### US 0011 (Yamila Carrada)

Obtain the number of products on promotion from a specific seller.
...
| `promo_products_count`   | `int`     | **Required**. number of products on promotion                                     |

#### US 0012 (Yamila Carrada)

Obtain the list of posts with discount from a specific seller.

```http
  GET /products/user-discount-posts/1465
