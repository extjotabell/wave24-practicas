...
public class SocialController {
    ...
    public ResponseEntity<?> postPromoProduct(@RequestBody PostPromoDto postPromoDto){
        return new ResponseEntity<>(postService.postPromo(postPromoDto), HttpStatus.OK);
    }

    @GetMapping("/products/promo-post/count")
    public ResponseEntity<PromoProductCountDto> countPromoPost(@RequestParam Integer user_id){
        return new ResponseEntity<>(postService.countPromoPost(user_id), HttpStatus.OK);
    }

    @GetMapping("/products/user-discount-posts/{userId}")
    public ResponseEntity<List<PostPromoDto>> getUserPostsWithDiscount(@PathVariable Integer userId){
            return new ResponseEntity<>(postService.discountUserPosts(userId),HttpStatus.OK);
    }
