...
public class ExceptionController {
    ...
    public ResponseEntity<ErrorResponseDTO> handleDataExtractionException(DataExtractionException e) {
        return globalErrorResponse(500, e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
