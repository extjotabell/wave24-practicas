...
public class Mapper {
    ...
    public PostPromDto convertPostPromToDto(Post entity){
        return new PostPromDto(
                entity.getUserId(),
                entity.getDate(),
                convertProductToDto(entity.getProduct()),
                entity.getCategory(),
    ...
    public Post convertDtoToPostProm(PostPromDto postPromDto){
        Post entity = new Post();
        entity.setUserId(postPromDto.user_id());
        entity.setDate(postPromDto.date());
        entity.setProduct(convertDtoToProduct(postPromDto.product()));
        entity.setCategory(postPromDto.category());
        entity.setPrice(postPromDto.price());
        entity.setHasPromo(postPromDto.has_promo());
