...
public class GlobalExceptionController {
    ...
    @ExceptionHandler(DownloadDocException.class)
    public ResponseEntity<ExceptionDTO> handleDownloadDocException(DownloadDocException e){
        ExceptionDTO exceptionDAO = new ExceptionDTO(e.getMessage());
        return new ResponseEntity<>(exceptionDAO, HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
