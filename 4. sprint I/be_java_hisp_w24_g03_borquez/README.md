...
#### US 0010 (Victoria Borquez)

Post a new product on promotion.
...
| `category` | `int` | **Required**. category of product. ex 100: Sillas, 58: Teclados|
| `price` | `double` | **Required**. price of product|
| `has_promo` | `boolean` | **Required**. true or false field to determine if a product is on promotion or not|
| `discount` | `double` | **Required**. if a product is on promotion, establish the discount amount|


#### US 0011 (Victoria Borquez)

Number of products on promotion from a specific seller.
...
| Parameter | Type     | Description                |
| :-------- | :------- | :------------------------- |
| `user_id` | `int` | **Required**. id of seller|
| `user_name` | `String` | **Required**. name of user|
| `promo_products_count` | `int` | **Required**. quantity of products in promotion of a certain user|
...
#### US 0012 (Victoria Borquez)


Delete a user, their publications and from the followers and followed lists.
