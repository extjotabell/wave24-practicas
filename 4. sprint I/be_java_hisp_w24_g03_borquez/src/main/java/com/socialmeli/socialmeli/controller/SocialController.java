...
public class SocialController {
    ...
    public ResponseEntity<List<UserTotalDto>> getAllUsersWithFollow() {
        return ResponseEntity.ok(userService.getAllUsersWithFollow());
    }
    ...
    public ResponseEntity<?> getTotalPromoProducts(@RequestParam Integer user_id){
        return new ResponseEntity<>(postService.getTotalPromoProducts(user_id), HttpStatus.OK);
    }

    @DeleteMapping("/users/deleteById/{user_id}")
    public ResponseEntity<?> deleteUserById(@PathVariable Integer user_id){
        return new ResponseEntity<>(userService.deleteById(user_id), HttpStatus.OK);
    }
