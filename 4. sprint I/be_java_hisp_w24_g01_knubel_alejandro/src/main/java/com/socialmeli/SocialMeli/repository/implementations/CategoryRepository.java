...
import com.socialmeli.SocialMeli.exception.CategoryNotFoundException;
...
public class CategoryRepository implements ICategoryRepository {
    ...
    public Category findByIdNoDTO(Integer categoryDTO) {
        return this.findById(categoryDTO).orElseThrow(() -> new CategoryNotFoundException("Categoria no encontrada")
        );
    }

    @Override
    public boolean categoryExists(int category_id) {
        return this.findById(category_id).isPresent();
    }
