...
public class ProductController {
    ...
    public ResponseEntity<?> getPromoCountOfUser(@RequestParam("user_id") Integer userId ){
        return new ResponseEntity<>(productService.countPromoOfUser(userId), HttpStatus.OK);
    }
}
