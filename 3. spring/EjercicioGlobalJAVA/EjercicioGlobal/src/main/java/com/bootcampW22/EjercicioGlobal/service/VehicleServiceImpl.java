...
public class VehicleServiceImpl implements IVehicleService{
    ...
    @Override
    public List<VehicleDto> getVehiclesByWeightRange(Double weight_min, Double weigth_max) {

        List<Vehicle> filteredVehicles = vehicleRepository.findAll().stream()
                .filter(vehicle -> vehicle.getWeight() >= weight_min && vehicle.getWeight() <= weigth_max)
                .toList();
