...
public class CharacterRepositoryImpl implements CharacterRepository {
    ...
    public CharacterRepositoryImpl(){
        this.characterEntities = new ArrayList<>(List.of(
    ...
    public List<CharacterEntity> findByNameMatch(String nameMatch) {
        return this.characterEntities.stream().filter(characterEntity -> characterEntity.getName().toLowerCase().contains(nameMatch.toLowerCase())).toList();
    }
}
