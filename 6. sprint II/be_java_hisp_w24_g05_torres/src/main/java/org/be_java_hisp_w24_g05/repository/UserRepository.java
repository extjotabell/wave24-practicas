...
public class UserRepository implements IUserRepository{
    ...
    public User removeFollower(User user, int userIdToUnfollow) {
        ...
        User userToUnfollow = this.users.stream().filter(u -> u.getUserId() == userIdToUnfollow).findFirst().orElseThrow(() -> new BadRequestException("User with id " + userIdToUnfollow + " not found"));

        System.out.println(userToUnfollow.getUserName());
