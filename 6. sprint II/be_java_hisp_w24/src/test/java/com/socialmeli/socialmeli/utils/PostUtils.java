...
public class PostUtils {
    ...
    PostDto postDtoId8 = new PostDto(1465,
            LocalDate.of(2024, 01, 20),
            new ProductDto(8, "Silla Gamer", "Gamer", "Racer", "Red", "Special Edition"),
            100,
            1500.50);

    PostDto postDtoWithNonexistentId = new PostDto(10,
            LocalDate.of(2024, 01, 02),
            new ProductDto(1, "Silla Gamer", "Gamer", "Racer", "Red", "Special Edition"),
            100,
            1500.50);

    PostIdDto postCreated = new PostIdDto(1465,
            2,
            LocalDate.now().minusDays(20),
            new ProductDto(1, "Silla Gamer", "Gamer", "Racer", "Red", "Special Edition"),
            100,
