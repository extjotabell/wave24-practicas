...
#### Test de Integración
| Test integración | Entry situations                                                                                                                                                     | Expected behavior                                                                                                                                  | Author           |
|:-----------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|
| T-0001           | Verificar que la cantidad de seguidores de un determinado usuario sea correcta.                                                                                      | **Se cumple:** permite continuar con normalidad <br>                                                                                               | Desiree Limachi  |
| T-0002           | Verificar que la creación de un post sea correcto.                                                                                                                   | **Se cumple:** permite continuar con normalidad <br> **No se cumple:** Notifica la no existencia del usuario mediante una excepción                | Desiree Limachi  |
| T-0003           | Verificar que el tipo de ordenamiento alfabético exista: name_asc , name_desc                                                                                        | **Se cumple:** permite continuar con normalidad <br>                                                                                               | Desiree Limachi  |
