...
public class UserServiceTest {
    ...
    public static final List<FollowerDTO> FOLLOWERSREVERSEDDTO2 = List.of(
            new FollowerDTO(104, "David Williams"),
            new FollowerDTO(105, "Eva Martinez")
    );

    public static final List<FollowerDTO> FOLLOWERSREVERSEDDTO3 = List.of(
            new FollowerDTO(102, "Bob Smith"),
            new FollowerDTO(105, "Eva Martinez")
    );
    ...
    public static final UserFollowedDTO USERFOLLOWEDDTO = new UserFollowedDTO(
            101,
            "Alice Johnson",
            FOLLOWERSREVERSEDDTO2);

    public static final UserFollowedDTO USERFOLLOWEDDTO3 = new UserFollowedDTO(
            101,
            "Alice Johnson",
            FOLLOWERSREVERSEDDTO3);
    ...
    @Test
    @DisplayName("Test that return followed list")
    public void getFollowedTest() {

        Integer userId = 101;
        String order = "name_asc";

        var expected = USERFOLLOWEDDTO3;

        Mockito.when(userRepository.findById(userId)).thenReturn(Optional.of(UserConstants.USER1));
        var result = userService.getFollowed(userId, order);
