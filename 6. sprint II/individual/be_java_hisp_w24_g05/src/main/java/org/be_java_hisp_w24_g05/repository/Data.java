...
public class Data {
    ...
    private static final List<User> FOLLOWED_BY_USER_1 = Arrays.asList(
            new User(2, "User2", new ArrayList<>(), new ArrayList<>(), Arrays.asList(POSTS.get(0),POSTS.get(1),POSTS.get(2))),
            new User(3, "User3", new ArrayList<>(), new ArrayList<>(), Arrays.asList(POSTS.get(3),POSTS.get(4)))
    );

    private static final List<User> FOLLOWERS_BY_USER_1 = Arrays.asList(
    ...
    private static final List<User> FOLLOWED_BY_USER_4 = Arrays.asList(
            new User(2, "User2", new ArrayList<>(), new ArrayList<>(), new ArrayList<>()),
            new User(3, "User3", new ArrayList<>(), new ArrayList<>(), new ArrayList<>())
    );
    private static final List<User> FOLLOWERS_BY_USER_4 = Arrays.asList(
            new User(1, "User1", new ArrayList<>(), new ArrayList<>(), new ArrayList<>())
    );

    private static final User USER_1 = new User(1, "User1", FOLLOWERS_BY_USER_1, FOLLOWED_BY_USER_1, Arrays.asList(POSTS.get(0), POSTS.get(1)));
    private static final User USER_2 = new User(2, "User2", new ArrayList<>(), new ArrayList<>(), Arrays.asList(POSTS.get(2), POSTS.get(3)));
    private static final User USER_3 = new User(3, "User3", new ArrayList<>(), new ArrayList<>(), Arrays.asList(POSTS.get(4), POSTS.get(5)));
    private static final User USER_4 = new User(4, "User4", FOLLOWERS_BY_USER_4, FOLLOWED_BY_USER_4, Arrays.asList(POSTS.get(6), POSTS.get(7)));

    public static ArrayList<User> loadData() {
        // return list of users
        return new ArrayList<>(Arrays.asList(USER_1, USER_2, USER_3, USER_4));
