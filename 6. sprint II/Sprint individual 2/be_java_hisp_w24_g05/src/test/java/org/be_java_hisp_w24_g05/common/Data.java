...
public class Data {
    ...
    private final List<User> FOLLOWED_BY_USER_1 = List.of(
    ...
    private final List<User> FOLLOWERS_BY_USER_1 = List.of(
            new User(2, "User2", new ArrayList<>(), new ArrayList<>(), new ArrayList<>()),
            new User(3, "User3", new ArrayList<>(), new ArrayList<>(), new ArrayList<>())
    );

    private final List<User> FOLLOWED_BY_USER_4 = List.of(
            new User(2, "User2", new ArrayList<>(), new ArrayList<>(), new ArrayList<>()),
            new User(3, "User3", new ArrayList<>(), new ArrayList<>(), new ArrayList<>())
    );

    private final User USER_1 = new User(1, "User1", FOLLOWERS_BY_USER_1, FOLLOWED_BY_USER_1, List.of(POSTS.get(0), POSTS.get(1)));
    private final User USER_2 = new User(2, "User2", new ArrayList<>(), new ArrayList<>(), List.of(POSTS.get(2), POSTS.get(3)));
    private final User USER_3 = new User(3, "User3", new ArrayList<>(), new ArrayList<>(), List.of(POSTS.get(4), POSTS.get(5)));
    private final User USER_4 = new User(4, "User4", new ArrayList<>(), FOLLOWED_BY_USER_4, List.of(POSTS.get(6), POSTS.get(7)));

    public List<User> loadData() {
        return List.of(USER_1, USER_2, USER_3, USER_4);
    }
}
